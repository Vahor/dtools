...
const DashboardLayoutchatChatIndexRoute = DashboardLayoutchatChatIndexImport.update({
  path: '/',
...
const DashboardLayoutchatChatTabidIndexRoute = DashboardLayoutchatChatTabidIndexImport.update({
  path: '/$tab_id/',
  getParentRoute: () => DashboardLayoutchatChatRoute,
} as any);

const DashboardLayoutchatChatTabidEditRoute = DashboardLayoutchatChatTabidEditImport.update({
  path: '/$tab_id/edit',
  getParentRoute: () => DashboardLayoutchatChatRoute,
} as any);
